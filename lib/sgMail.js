...
export const sendPasswordChangedEmail = async (to, name) => {
  const msg = {
    to,
    from: process.env.SEND_GRID_EMAIL,
    subject: 'Password changed on NextStack website',
    text: 'You have successfully changed your password on NextStack website.',
    html: `
        <div>
            <h1>Hey ${name}, your password has been changed!✌️</h1>
            <p>You have successfully change your password on ${moment().format(
              'MMM Do YYYY'
            )}.</p>
        </div>
    `,
